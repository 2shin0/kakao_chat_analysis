...
from analysis import generate_basic_statistics, generate_wordcloud, perform_sentiment_analysis, making_topic_modeling, making_cluster ## text_to_network_graph
...
if choice == '데이터':
    ...
    if 'df_filtered' in st.session_state:
        ...
        # Tabs for analysis
        tabs = st.tabs(['기본 통계', '워드클라우드', '감정 분석', '토픽 분석', '군집 분석']) ## '네트워크 그래프'
        ...
        # with tabs[5]:
        #     network_graph = text_to_network_graph(df_filtered)
        #     st.image(network_graph)
    else:
        st.write("데이터가 필요합니다.")